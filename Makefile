...
SOURCES = \
	__init__.py \
	flow_trace.py flow_trace_dialog.py

PLUGINNAME = flow_trace

PY_FILES = \
	__init__.py \
	flow_trace.py flow_trace_dialog.py

UI_FILES = flow_trace_dialog_base.ui
...
QGISDIR=C:\Users\eboesenberg\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
